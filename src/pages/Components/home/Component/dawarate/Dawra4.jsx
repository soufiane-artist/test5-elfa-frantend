...
function Dawra4({setTitle}) {

    const navigate= useNavigate()
    
    const title = "Drawing basics for beginners - تعليم اساسيات الرسم من الصفر"
    const buy =()=>{
      setTitle(title)
      navigate('/طلب-الدورة')
    }
      ...
      <div className='dawra7'>
         <div className="CreatePost-header">
            ...
            <div className="dawra7-container">
                <video controls src="./videos/Drawing basics for beginners - تعليم اساسيات الرسم من الصفر.mp4"></video>
            <div className="dawra7-container-text">
               <h2>{title} </h2>
                <p>اتعرف علي اهم خطوات تعلم الرسم بطريقه علميه صحيحه لتطوير مهارتك ومستواك في وقت قليل ابتداءا من الصفر ووصولا الى الاحتراف 
                </p>
                ...
                <h5 id='price'>149 درهم <span>190 درهم</span> </h5>
