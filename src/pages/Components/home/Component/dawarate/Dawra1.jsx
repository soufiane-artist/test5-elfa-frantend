...
function Dawra1({setTitle}) {

    const navigate= useNavigate()

    
    
    const title = "كورس تعلم رسم شخصيات الانمي _ من مبتدئ الى خبير"
    useEffect(()=>{
        window.scroll(0,0)
    },[title])
    const buy =()=>{
    ...
    <div className='dawra7'>
         <div className="CreatePost-header">
            ...
            <div className="dawra7-container">
                <video controls src="./videos/كورس تعلم رسم الشخصيات( الأنمي) _ من مبتدئ لخبير.mp4"></video>
            <div className="dawra7-container-text">
               <h2>{title} </h2>
                <p>تعلم كيفية رسم الشخصيات ,رسم الأنمي للمبتدئين ، ابتكار شخصيات للرسوم المتحركة ، والرسوم الهزلية ، والألعاب والمزيد
                </p>
                ...
                <h5 id='price'>149 درهم <span>990 درهم</span> </h5>
