...
function Dawra6({setTitle}) {

    const navigate= useNavigate()

    
    const title = "تعليم رسم الوجه كاريكاتير للمبتدئين من الصفر"
    const buy =()=>{
        setTitle(title)
        navigate('/طلب-الدورة')
    }
    ...
    <div className='dawra7'>
         <div className="CreatePost-header">
            ...
            <div className="dawra7-container">
                <video controls src="./videos/تعليم رسم الوجه كاريكاتير للمبتدئين من الصفر.mp4"></video>
            <div className="dawra7-container-text">
               <h2>{title} </h2>
                <p>اكتشف قدراتك فى رسم الكاريكاتير ببساطة
                </p>
                <h5>4.8 <span><FaStar/><FaStar/><FaStar/><FaStar/><FaStar/></span> (79) </h5>
                ...
                <h5 id='price'>149 درهم <span>290 درهم</span> </h5>
