...
function Dawra7({setTitle}) {

    const navigate= useNavigate()

    
    const title = "تعليم أساسيات الرسم للأطفال"
    const buy =()=>{
        setTitle(title)
        navigate('/طلب-الدورة')
    }
    ...
    <div className='dawra7'>
         <div className="CreatePost-header">
            ...
            <div className="dawra7-container">
                <video controls src="./videos/تعليم أساسيات الرسم للأطفال.mp4"></video>
            <div className="dawra7-container-text">
               <h2>{title} </h2>
                <p>هل تبحثون عن دورة باللغة العربية لتعليم الأساسيات لأطفالكم المهتمين بالرسم؟ هذه الدورة هي الأنسب لكم</p>
                ...
                <h5 id='price'>190 درهم <span>800 درهم</span> </h5>
