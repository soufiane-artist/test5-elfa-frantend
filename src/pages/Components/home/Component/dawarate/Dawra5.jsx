...
function Dawra5({setTitle}) {

    const navigate= useNavigate()

    
    const title = "الرسم الحر و ثلاثي الابعاد بقلم الرصاص"
    const buy =()=>{
        setTitle(title)
        navigate('/طلب-الدورة')
    }
    ...
    <div className='dawra7'>
         <div className="CreatePost-header">
            ...
            <div className="dawra7-container">
                <video controls src="./videos/0918(1).mp4"></video>
            <div className="dawra7-container-text">
               <h2>{title} </h2>
                <p>هذا الكورس هو هدية لكل من يبحث عن إتقان موهبة مميزة تثري حياته بدون أي معرفة مسبقة
                </p>
